...
function FindPassword() {
  return (
    ...
    {/* border-solid border border-slate-100 rounded-2xl shadow-md shadow-slate-300 */}
      ...
      <p className="text-ppVeryLightGray pt-10 text-start">가입하신 이메일 주소를 입력해 주세요.
        <br/>비밀번호를 다시 설정할 수 있는 메일을 보내드립니다.</p>
      <div className="flex flex-col pt-8 pb-4">
        ...
        <Link to={'/setpw'}>
          <BtnLarge bgColor={'bg-ppBlue my-4 hover:bg-ppMoveBlue text-ppWhite'} text={'이메일 보내기'} />
        </Link>
      </div>
    </div>
  )
