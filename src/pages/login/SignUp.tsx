...
function SignUp() {
  ...
  const handleClickSubmit = (event: any) => {
    ...
    console.log('제출중');
    axios
      .post('http://175.45.203.93:3389/planpeak/signup', {
        mem_email: userInfo.email,
        mem_name: userInfo.name,
        mem_password: userInfo.password,
        mem_gender: userInfo.gender,
        mem_age: `${userInfo.year}${userInfo.month}${userInfo.day}`,
        mem_address: userInfo.region,
        mem_consent: userInfo.emailAgreeCheck,
        mem_marketing: userInfo.marketingAgreeCheck,
      })
      .then((result) => {
        console.log('성공');
        console.log(result);
    ...
    <div className="w-5/12 py-10 px-20 mx-auto my-40 text-center content-center">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex font-medium items-center">
          <p className="py-4 px-4 my-2 text-lg  text-ppGray">성별</p>
          <div className="flex px-4 text-lg text-ppGray">
            <input
              ...
              onChange={handleInput}
            />
            <label htmlFor="male" className="py-4 px-4 my-2">
              남
            </label>
            <input
              type="radio"
              ...
              onChange={handleInput}
            />
            <label htmlFor="female" className="py-4 px-4 my-2">
              여
            </label>
          </div>
        </div>
        ...
        <div className="flex">
          <p className="py-4 px-4 my-2 text-lg font-medium text-ppGray">지역</p>
          <select
            id="region"
            name="region"
        ...
        <div className="form-group pl-4 text-left text-ppVeryLightGray">
          <div className="flex">
            ...
            />
            <label htmlFor="emailAgreeCheck" className="p-2">
              이메일 수신 동의
            </label>
          </div>
          <div className="flex">
            <input
              ...
              onChange={handleCheckbox}
            />
            <label htmlFor="marketingAgreeCheck" className="p-2">
              마케팅 정보 수신 동의
            </label>
          </div>
        </div>
